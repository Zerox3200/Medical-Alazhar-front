...
const UpdateVideoForm = ({ isOpen, onClose, onSubmit, chapter, courseId, uploadProgress, videoData, refetch }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values) => {
            ...
            const needeData = {
                ...
                // Only send videoFile if a new file is uploaded
                ...(values.videoFile && { videoFile: values.videoFile })
            }
                        ...
                        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-800">Update Video</h3>
                                        <p className="text-sm text-gray-600">
                                            {chapter ? `Update to: ${chapter.title}` : 'Select a chapter first'}
                                        </p>
                                    </div>
                                </div>
                                <button
                        ...
                        <div className="p-6 space-y-6">
                            <form onSubmit={formik.handleSubmit} className="space-y-6">
                                ...
                                <div className="pt-4 border-t border-gray-200">
                                    <button
                                        type="submit"
                                        disabled={formik.isSubmitting || !formik.isValid || uploadProgress < 100}
                                        ...
                                        <div className="relative z-10 flex items-center justify-center space-x-2">
                                            {formik.isSubmitting ? (
                                                <>
                                                    ...
                                                    <span>
                                                        {uploadProgress ? `Uploading... ${uploadProgress}%` : 'Updating Video...'}
                                                    </span>
                                                </>
                                            ) : (
                                                <>
