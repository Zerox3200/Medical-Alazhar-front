...
const AddSectionForm = ({ isOpen, onClose, onSubmit, courseId, order }) => {
                        ...
                        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4">
                            <div className="flex items-center justify-between">
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        <h3 className="text-lg font-semibold text-gray-800">Add Section</h3>
                                        <p className="text-sm text-gray-600">Create a new course section</p>
                                    </div>
                                </div>
                                <button
                                    onClick={handleClose}
                            ...
                            <form onSubmit={formik.handleSubmit} className="space-y-6">
                                ...
                                <div className="pt-4 border-t border-gray-200">
                                    ...
                                    >
                                        ...
                                        <span>{formik.isSubmitting ? 'Adding Section...' : 'Add Section'}</span>
                                    </button>
                                </div>
                            </form>
                        </div>
