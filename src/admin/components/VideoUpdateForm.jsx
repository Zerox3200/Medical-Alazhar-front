...
const VideoUpdateForm = ({ isOpen, onClose, onSubmit, isLoading = false, refetch, videoData }) => {
    ...
    // Update form when videoData changes
    React.useEffect(() => {
        if (videoData && isOpen) {
            formik.setValues({
            ...
            setFilePreview(videoData.videoUrl || videoData.url);
    ...
    const HandleSubmit = async (values) => {
        try {
            ...
            // Only include videoFile if a new file is selected
            if (!hasNewVideo) {
                delete updateData.videoFile;
            }

            const response = await onSubmit(updateData, setUploadProgress);
    ...
    const removeFile = () => {
        ...
        setHasNewVideo(false);
        if (filePreview && filePreview !== (videoData?.videoUrl || videoData?.url)) {
                    ...
                    >
                        ...
                        <div className="flex items-center justify-between p-6 border-b border-gray-200 bg-gray-50">
                            <div className="flex items-center space-x-3">
                                ...
                                <div>
                                    <h2 className="text-lg font-bold text-gray-800">Update Video</h2>
                                    <p className="text-sm text-gray-600">Edit video information</p>
                                </div>
                            </div>
                            <button
                                onClick={onClose}
                        ...
                        <div className="flex-1 overflow-y-auto p-4 sm:p-6 min-h-0">
                            <form onSubmit={formik.handleSubmit} className="space-y-4 sm:space-y-6">
                                ...
                                <div>
                                    ...
                                    <div
                                        className={`border-2 border-dashed rounded-xl p-4 sm:p-6 text-center transition-all duration-200 cursor-pointer ${dragActive
                                            ...
                                            <div className="space-y-4">
                                                ...
                                                <div>
                                                    <p className="text-lg font-semibold text-gray-700 mb-2">
                                                        Drop a new video here
                                                    </p>
                                                    <p className="text-sm text-gray-600 mb-4">
                                                        or click to browse files to replace current video
                                                    </p>
                                                    <input
                                                        type="file"
                                                        accept="video/*"
                                    ...
                                    <div className="mt-4">
                                        ...
                                        <div className="bg-gray-50 rounded-xl p-4 border border-gray-200">
                                            <div className="flex items-center space-x-3 mb-3">
                                                ...
                                                <div>
                                                    <p className="font-semibold text-gray-800">Current Video</p>
                                                    <p className="text-sm text-gray-600">Existing video file</p>
                                                </div>
                                            </div>
                                            <video
                            ...
                            >
                                {isLoading || isUploading ? (
                                    <>
                                        ...
                                        <span>{isUploading ? `Updating... ${uploadProgress}%` : 'Updating...'}</span>
                                    </>
                                ) : (
                                    <>
                                        <FaUpload className="text-sm" />
