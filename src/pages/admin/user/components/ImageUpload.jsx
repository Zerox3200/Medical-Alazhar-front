...
const ImageUpload = ({
  ...
  return (
    <div className="rounded-sm mb-4 relative group bg-softGray min-h-64 flex flex-center justify-center">
      ...
      <div className="bg-darkGray/20 absolute w-full h-full inset-0 opacity-0 duration-200 transition-all group-hover:opacity-100 flex flex-col justify-center items-center text-softGray">
        <input
          type="file"
          accept="image/*"
          id={inputId}
