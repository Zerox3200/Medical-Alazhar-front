...
import { FaGraduationCap, FaUsers, FaGlobe, FaAward, FaLaptop, FaHeart } from "react-icons/fa";
...
const Statistics = () => {
    ...
    return (
        <section id="statistics-section" className="py-20 bg-gradient-to-br from-lightBlue/5 to-blue-600/5">
